                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-10 align-items-center ">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="<?=$user['no_dokter']?>" id="no_dokter" name="no_dokter" readonly>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="0<?=$user['no_telp']?>" id="no_telp" name="no_telp">
                            </div>
                            <div class="mb-3">
                                <label for="spesialisasi" class="form-label">Spesialisasi</label>
                                <input type="text" class="form-control" value="<?=$user['spesialisasi']?>" id="spesialisasi" name="spesialisasi">
                            </div>
                        </div>
                    </div>
            </div>
